			...
			for (var i = 0; i < splt.length; i++)
			{
				TenantObject.GetByID(splt[i], function(sender1, e1)
				{
					e1.Items[0].GetInstances(function(sender2, e2)
					{
						...
						{
							sender.Items.Add({ "Title": e2.Items[j].ToString(), "Value": e2.Items[j].GetInstanceID(), "TargetURL": System.ExpandRelativePath("~/instances/execute/" + e2.Items[j].GetInstanceID()) });
						}
